...
pcaAnalysis <- ggplot(params$pcaAnalysis, aes(PC1, PC2)) + 
    ...
    labs(title = paste("PCA Analysis of Changed Diagnostics<br>", pcaInfo["PC1"] + pcaInfo["PC2"], "% variability explained by PC1 and PC2", sep = ""))  +
...
pcaSelected <- ggplot(params$pcaAnalysisSelected, aes(PC1, PC2)) + 
    ...
    labs(title = paste("PCA Analysis of Changed Diagnostics in selected predictors<br>", pcaInfo["PC1Selected"] + pcaInfo["PC2Selected"], "% variability explained by PC1 and PC2", sep = ""))  +
    theme(plot.title.position = "panel",
        plot.title = element_markdown(),
        legend.position = "right")
```
